  ...
  return (
    <div className="header min-w-screen z-40 flex h-16 items-center justify-between border-b border-moss-800 px-4">
      <div className="flex w-1/4 items-center">
        <div className="font-cardo text-lg font-bold tracking-wider-1 text-moss-950 sm:text-xl">
          &apos;kliː.mə´
        </div>
      </div>
      <div className="flex w-1/2 justify-center">
        <div className="flex items-center justify-center">
          <button className="snipcart-checkout group cursor-pointer text-center font-maven text-sm font-light tracking-wider-2 text-moss-950 transition duration-300 sm:text-base">
            cart
